...
namespace Exterrestris\DtoFramework\Tests\Dto\Dto;
...
use Exterrestris\DtoFramework\Dto\Dto\Exception\InternalDtoPropertyException;
use Exterrestris\DtoFramework\Dto\Dto\Exception\InvalidDataException;
use Exterrestris\DtoFramework\Dto\Dto\Exception\NoSuchDtoPropertyException;
    ...
    public static function invalidDataProvider(): array
    {
        return [
            ...
            [
                ...
                NoSuchDtoPropertyException::class,
            ],
            [
                [
                    'internal' => 'value',
