...
use Exterrestris\DtoFramework\Validation\Rules\NotNullIfNot;
...
#[CoversClass(NotNullIfNot::class)]
#[UsesClass(PropertyValidationException::class)]
#[UsesClass(ValueException::class)]
class NotNullIfNotTest extends DependentPropertyValidatorTestCase
{
    ...
    {
        return new NotNullIfNot('dependsOn', 'value', ...$params);
    }
}
