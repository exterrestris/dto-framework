...
namespace Exterrestris\DtoFramework\Tests\Validation\Validator;
...
use Exterrestris\DtoFramework\Validation\Validator\ItemValidator;
...
class ItemValidatorTest extends TestCase
{
     ...
     * @param array<string, class-string<PropertyValidatorInterface>[]> $expectedInvalidProperties
     ...
     * @param bool $enforcePreferences
     * @param array<int, array{array<string, class-string<PropertyValidatorInterface>[]>, string[]}> $expectedInvalidDtos
     * @return void
     */
    ...
    public function testValidateInvalidCollection(
        ...
        try {
            ...
            foreach ($invalidDtoExceptions as $dtoIndex => $invalidDtoException) {
                ...
                [$expectedInvalidProperties, $expectedRequiredProperties] = $expectedInvalidDtos[$dtoIndex];
