...
use Exterrestris\DtoFramework\Validation\Rule\Exception\RequireOneOfValidationException;
use Exterrestris\DtoFramework\Validation\Rule\RequireOneOf;
...
class RequireOneOfTest extends TestCase
{
    ...
    protected function getValidator(): PropertyValidatorInterface
    {
