...
readonly class DateBeforeProperty extends AbstractDependentPropertyPropertyValidator
{
    protected function validateValueAgainst(mixed $value, mixed $dependentValue): void
    {
        ...
        if ($value >= $dependentValue) {
            throw new ValueException(sprintf('Value must be before %s', $this->property));
        }
    }
}
