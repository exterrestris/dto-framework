...
class DateOnOrAfter extends AbstractDatePropertyValueValidator
{
    /**
    ...
    {
        if ($value < $date) {
            throw new ValueException(sprintf('Value must be equal to or after %s', $date->format($dateFormat)));
        }
    }
}
