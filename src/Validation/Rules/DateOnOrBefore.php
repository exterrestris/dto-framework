...
class DateOnOrBefore extends AbstractDatePropertyValueValidator
{
    /**
    ...
    {
        if ($value > $date) {
            throw new ValueException(sprintf('Value must be before or equal to %s', $date->format($dateFormat)));
        }
    }
}
